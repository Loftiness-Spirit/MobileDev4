    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.list.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ListView listView = ListView.newInstance(mParam1,"");
                fragmentTransaction.replace(R.id.fragment_container, listView).addToBackStack(null).commit();
            }
        });
        binding.recycler.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                RecycleView recycleView = RecycleView.newInstance(mParam1, "");
                fragmentTransaction.replace(R.id.fragment_container, recycleView).addToBackStack(null).commit();
            }
        });
